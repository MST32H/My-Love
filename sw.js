const CACHE='mb-xviii-v6';
const ASSETS=['./','./index.html','./manifest.json','./assets/noir.webp','./assets/gold.webp','./assets/cafe.webp','./assets/studio.webp','./assets/park.webp','./assets/beach.webp','./assets/icon-192.png','./assets/icon-512.png'];
